...
are functions. Functions receive parameters and \colortt{return} a value:
  ...
  \sectionBox{Arrays (chs 5, 6, \& 11)}{%
    \noindent Arrays are a list of things (strings, objects, arrays).
...
picker
  ...
  \sectionBox{Objects (chs 5, 6, \& 11)}{%
    \noindent Objects are generic types and have properties.
      ...
      \begin{center}
        \small{\addvbuffer[-12pt 0pt]{%
          \begin{tabulary}{\textwidth}{LL}
            ...
            \colortt{<h2></h2>} & 2nd-level heading (goes all the way to \colortt{<h6>}) \\
...
\colortt{L.someMethod()}.
    ...
    \lstinputlisting[firstline=21, lastline=38]{leaflet.js}
  }
